...
const Editor = (() => {
  ...
  function parse(raw) {
    ...
    if (match) {
      ...
      yaml.split("\n").forEach((line) => {
        ...
        // Array sederhana: [a, b, c]. Coba JSON.parse lebih dulu agar koma di dalam teks FAQ tetap aman.
  ...
  function serialize(meta, body) {
    ...
    const order = ["title", "slug", "date", "status", "category", "author", "tags", "excerpt", "featured_image", "featured_image_alt", "faq_title", "faq_description", "faq"];
